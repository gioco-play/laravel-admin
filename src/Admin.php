...
use Closure;
use GiocoPlus\Admin\Auth\Database\Menu;
use GiocoPlus\Admin\Controllers\AuthController;
use GiocoPlus\Admin\Layout\Content;
use GiocoPlus\Admin\Traits\HasAssets;
use GiocoPlus\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \GiocoPlus\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \GiocoPlus\Admin\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\GiocoPlus\Admin\Controllers')->group(function ($router) {
